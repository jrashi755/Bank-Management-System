...
import java.awt.*;
import java.awt.event.*;//for frame
import javax.swing.*;//for button fields etc
// java.sql.*;//this SQL package allows us to select, insert, update, and delete data in SQL tables.
...
public class Signup1 extends JFrame implements ActionListener {
    ...
    JRadioButton r1,r2,r3,r4,r5;//mcq option
    JButton b;
    JComboBox<String> c1,c2,c3;//selection from list
    ...
    Signup1() {
        ...
        /*ImageIcon i1 = new ImageIcon("C:\\Users\\user\\Pictures\\signup1.png");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(t1.getText().equals("")){
                ...
                JOptionPane.showMessageDialog(null,"Fill all the required fields");
            }else if(!r3.isSelected()&&!r4.isSelected()&&!r5.isSelected()){
                JOptionPane.showMessageDialog(null,"Fill all the required fields");
            }
            else{
                
                //Conn c1 = new Conn();
                q1="insert into signup values('"+a+"','"+b+"','"+ac+"','"+bc+"','"+cc+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"','"+j+"','";
                //c1.s.executeUpdate(q1);//to insert values in database
